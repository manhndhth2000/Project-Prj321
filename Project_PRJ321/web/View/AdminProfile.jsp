            ...
            <div class="row">
                <div class="col-sm-3"><!--left col-->
                    <div class="text-center">
                        <form action="${pageContext.request.contextPath}//UploadImageAdmin?username=${sessionScope.user.getUsername()}" method="post" enctype="multipart/form-data">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img id="img" src="../image/Admin/${sessionScope.user.getImage()}" class="avatar img-circle img-thumbnail" alt="avatar">
                                </c:otherwise>
                            </c:choose>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home">
                            <form action="${pageContext.request.contextPath}//UpdateAdminProfile">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="date" class="form-control" name="dob" value="${sessionScope.user.getDob() == null?"":sessionScope.user.getDob()}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <label><h4>Introduction</h4></label>
                                        <textarea style="resize: none" rows="7" class="form-control" name="intro">${sessionScope.user.getInformation() == null?"":sessionScope.user.getInformation()}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
