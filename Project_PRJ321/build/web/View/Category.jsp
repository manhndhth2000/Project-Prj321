<%-- 
    Document   : Category
    Created on : Jun 30, 2021, 4:09:01 PM
    Author     : ADMIN
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <h1 class="page-header">
                        ${categoryName}
                        <small>Let's experience with us</small>
                    </h1>
                    <c:forEach items="${list}" var="i">
                        ...
                        <hr>
                        <img class="img-responsive" src="<% out.print(request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/image/Detail/");%>${i.image}" alt="http://placehold.it/900x300">
                        <hr>
                        <p>${i.shortDes}</p>
                        <hr>
                    </c:forEach>
                            ...
                            <c:if test="${endPage >= 1}">
                                <c:forEach begin="1" end="${endPage}" var="i">
                                    <li class='${i==index?"active":""}'>
                                        <a class="page-link" href="${pageContext.request.contextPath}//CategoryController?name=${categoryName}&index=${i}">${i}</a>
                                    </li>
                                </c:forEach>
                            </c:if>
                ...
                <div class="col-md-4">
                    ...
                    <div class="well">
                        ...
                        <p style="text-align: justify">${category.shortDes}</p>
                    </div>
