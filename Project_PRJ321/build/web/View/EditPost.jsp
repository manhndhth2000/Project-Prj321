<%-- 
    Document   : EditPost
    Created on : Jul 13, 2021, 11:46:17 PM
    Author     : ADMIN
--%>
    ...
    <head>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="a">
                        <form action="${pageContext.request.contextPath}//uploadImagePost?title=${blogPost.title}&timePost=${blogPost.timePost}" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <img id="img" src="../image/Detail/${blogPost.image}" class="avatar img-responsive" alt="avatar">
                                <h3>Upload a different photo...</h3>
                                <input type="file" name="photo" class="file-upload" accept="image/png, image/jpeg">
                            </div>
                            <input type="submit" name ="submit" class="btn btn-default" value="Submit image">
                        </form>  
                    </div>
                    <div class="b">
                        <form action="${pageContext.request.contextPath}//editContentController">
                            <div class="form-group">
                                <label>Title</label>
                                <input class="form-control" type="text" name="title" value='${blogPost.title}'>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control">
                                    <c:forEach items="${listCategory.allCategory}" var="i">
                                        <c:choose>
                                            <c:when test="${i.name == blogPost.category}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" class="form-control" name="shortDes"  rows="3">${blogPost.shortDes}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea style="resize: none" class="form-control" name="description"  rows="10">${blogPost.description}</textarea>
                            </div>
