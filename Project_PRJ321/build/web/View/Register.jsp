<%-- 
    Document   : Register
    Created on : Jun 12, 2021, 10:35:39 AM
    Author     : ADMIN
--%>
            ...
            <span style="font-size:12px;">
                <span style="font-family:arial,helvetica,sans-serif;">
                    <form action="${pageContext.request.contextPath}//RegisterController">
                        ...
                        <input placeholder="Re-password" type="password" name="re-password" required="">
                        ...
                        <p style="text-align: center; color: red; font-size: 100%"><i><strong><%=(request.getAttribute("message") == null) ? "" : request.getAttribute("message")%></strong></i></p>
