<%-- 
    Document   : Home
    Created on : Jun 22, 2021, 4:23:38 PM
    Author     : ADMIN
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <c:forEach items="${a.top3ListPost}" var="i">
                        <h2>
                        ...
                        <hr>
                        <img class="img-responsive" src="../image/Detail/${i.image}" alt="photo">
                        <hr>
                        <p>${i.shortDes}</p>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="${pageContext.request.contextPath}//HomeController?index=1"><button class="btn btn-primary">Learn more</button></a>
                            </li>
                        </ul>
                    </nav>
                </div>
