...
public class UpdateAdminProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Date time = new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("dob"));
            java.sql.Date dob = new java.sql.Date(time.getTime());
            String infor = request.getParameter("intro");
            Admin admin = new Admin();
            admin.updateUser(username, name, infor, email, dob);
