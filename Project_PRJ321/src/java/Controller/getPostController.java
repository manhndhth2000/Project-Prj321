 ...
 * @author ADMIN
 */
@WebServlet(name = "getPostController", urlPatterns = {"/getPostController"})
public class getPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            BlogPost blogPost = new BlogPost().getPostByTitle(title, timePost);
            request.setAttribute("blogPost", blogPost);
            session.setAttribute("id", blogPost.getId());
